...
internal sealed class LegacyGpuBinding : IDisposable
{
    ...
    public LegacyGpuBinding(PartState part, SampleBehavior simulation, LegacyPoseBuffer pose, params ShaderMaterial[] materials)
    {
        this.part = part;
    ...
    private void BindStatic(ShaderMaterial material, SampleBehavior simulation, LegacyPoseBuffer pose)
    {
