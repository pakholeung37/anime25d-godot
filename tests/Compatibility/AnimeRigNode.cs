...
public partial class AnimeRigNode : AnimeModelNode
{
    ...
    public Anime25D.Runtime.AnimationRuntime? Animation => Instance?.Animation;
    ...
    public void LoadModel(AnimeRigModel model, Func<double>? randomSource = null)
    {
        ...
        var view = new ModelView(LegacySampleModelBuilder.Build(model.ReadDefinition(), profile, model.Animations, randomSource), model.Textures, new LegacyGpuFactory());
        var old = Simulation;
