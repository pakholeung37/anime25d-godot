...
public sealed class SampleReferenceAdapter
{
    ...
    public SampleBehavior Behavior { get; }
    ...
    public SampleReferenceAdapter(RigDefinition definition, Func<double>? randomSource = null, RigProfile? profile = null, AnimationModel? animations = null)
        : this(new ModelInstance(LegacySampleModelBuilder.Build(definition, profile, animations, randomSource))) { }
    public SampleReferenceAdapter(ModelInstance instance) { Instance = instance; Behavior = instance.Component<LegacyPlan.LegacyState>("legacy").Behavior; }
