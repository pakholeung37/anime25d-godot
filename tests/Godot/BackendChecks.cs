...
public partial class BackendChecks : Node
{
    ...
    private async Task CheckModel(string name)
    {
        ...
        int poseCallbacks = 0;
        void ObservePose(Anime25D.Runtime.ParameterSet parameters)
        {
        ...
        void ObserveRetargeted(Anime25D.Runtime.ParameterSet parameters) => retargetedYaw = parameters[nameof(Parameter.HeadYaw)];
