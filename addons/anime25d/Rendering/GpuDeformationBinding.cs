...
internal sealed class GpuDeformationBinding : IDisposable
{
    ...
    public GpuDeformationBinding(PartState part, RigSimulation simulation, GpuPoseBuffer pose, params ShaderMaterial[] materials)
    {
        this.part = part;
    ...
    private void BindStatic(ShaderMaterial material, RigSimulation simulation, GpuPoseBuffer pose)
    {
