...
public sealed class ModelDefinition
{
    ...
    public Func<ModelDefinition, IModelBehavior> CreateBehavior { get; }
    ...
    public ModelDefinition(AnimationModel animation, int canvasWidth, int canvasHeight, IEnumerable<LayerDefinition> layers,
        IEnumerable<MaskDefinition>? masks = null, Func<ModelDefinition, IModelBehavior>? behavior = null, Bounds2D? bounds = null)
    {
        ...
        CreateBehavior = behavior ?? (_ => new BasicModelBehavior());
    }
